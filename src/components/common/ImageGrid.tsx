...
import cows from '/Users/luisgc/Desktop/SP/seleccion_camas_ui/src/assets/images/cows.jpeg';
...
export default function ImageGrid({ src = cows, ngrids = 4, gridWidth = 300 }: Props) {
